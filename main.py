...
icono = pygame.image.load("media/ovni.png")
...
img_jugador = pygame.image.load("media/cohete.png")
jugador_x = 368
jugador_y = 510
jugador_x_cambio = 0
...
for e in range(cantidad_enemigos):
    img_enemigo.append(pygame.image.load("media/enemigo.png"))
...
img_bala = pygame.image.load("media/bala.png")
bala_x = 0
bala_y = 510
bala_x_cambio = 0
bala_y_cambio = 9
...
# Variable puntaje
puntaje = 0
fuente = pygame.font.Font('media/ArcadeClassic.ttf', 32)
texto_x = 10
texto_y = 10

# Texto final del juego
fuente_final = pygame.font.Font('media/ArcadeClassic.ttf', 70)
